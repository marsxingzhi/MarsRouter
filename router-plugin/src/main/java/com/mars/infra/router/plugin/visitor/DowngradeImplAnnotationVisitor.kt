 ...
 */
class DowngradeImplAnnotationVisitor (
    ...
    override fun visitEnd() {
        ...
        mServiceInterfaceList.forEach {type ->
            val downgradeImplData = DowngradeImplData(type.className, className!!, false, false)
            println("DowngradeImplAnnotationVisitor---downgradeImplData = $downgradeImplData")
            DowngradeImplManager.addData(downgradeImplData)
        }
    }
}